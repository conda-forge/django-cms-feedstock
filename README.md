...
pixi global install django-cms
```
...
It is possible to list all of the versions of `django-cms` available on your platform:
...
```
pixi search django-cms --channel conda-forge
```
